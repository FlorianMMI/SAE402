...
let renderMarket = function () {
  ...
  atable.addEventListener("click", function () {
    ...
    colors.forEach((color, index) => {
      ...
      aBox.setAttribute(
        "position",
        `${3 - (index % 5) * 0.5} ${3.1 - Math.floor(index / 5) * 1.5} 9`
      );
      ...
      atext.setAttribute(
        "position",
        `${3.25 - (index % 5) * 0.5} ${3.5 - Math.floor(index / 5) * 1.4} 9.25`
      );
  ...
  amarket.addEventListener("click", function () {
    ...
    characters.forEach((character, index) => {
      ...
      characterEntity.setAttribute(
        "position",
        `${3 - (index % 5) * 0.5} ${2.85 - Math.floor(index / 5) * 1.5} 9`
      );
      ...
      atext.setAttribute(
        "position",
        `${3.15 - (index % 5) * 0.5} ${3 - Math.floor(index / 5) * 1.4} 8.8`
      );
      atext.setAttribute("scale", "1 1 1");
      atext.setAttribute("rotation", "0 180 0");
      ascene.appendChild(atext);
